...
class DialogWidget extends StatefulWidget {
  const DialogWidget({
    ...
    this.onConfirm,
    this.onCancel,
  }) : assert(!(title == null && content == null && titleWidget == null && contentWidget == null),
...
class _DialogWidgetState extends State<DialogWidget> {
  ...
  Widget? get titleWidget =>
      widget.titleWidget ?? (widget.title != null ? Text(widget.title!, style: context.h4) : null);

  Widget? get contentWidget =>
      widget.contentWidget ?? (widget.content != null ? Text(widget.content!, style: context.p) : null);
        ...
        : SizedBox(
            ...
            child: Column(
              ...
              children: [
                if (hasTitle)
                  Padding(
                    padding: EdgeInsets.only(top: 20, left: 16, right: 16, bottom: hasContent ? 8 : 20),
                    child: titleWidget,
                  ),
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          if (hasTitle)
            Padding(
              padding: EdgeInsets.only(top: 28, left: 16, right: 16, bottom: hasContent ? 8 : 20),
              child: titleWidget,
            ),
          if (widget.content != null || widget.contentWidget != null)
            Padding(
              padding: EdgeInsets.only(top: hasTitle ? 0 : 36, left: 16, right: 16, bottom: 32),
              child: contentWidget,
            ),
          Column(
            mainAxisSize: MainAxisSize.min,
                  ...
                  builder: (isTap) {
                    return Container(
                      ...
                      child: buildButtonContent(
                        ...
                        child: Text(
                          widget.confirmText,
                          style: context.p.copyWith(color: getTextColor(confirmColor)),
                        ),
                      ),
                    );
                  },
                  ...
                  builder: (isTap) => Container(
                    ...
                    child: buildButtonContent(
                      ...
                      child: Text(
                        widget.cancelText,
                        style: context.p.copyWith(
                          color: getTextColor(confirmColor),
                        ),
                      ),
                    ),
                  ),
